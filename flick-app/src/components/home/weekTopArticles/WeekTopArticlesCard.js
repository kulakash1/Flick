...
export default function WeekTopArticlesCard(props) {
  return (
    ...
    //     </div>
    // </div>
    <div className="bg-[#6D435A] h-[400px] mb-4 hover:scale-105 transform transition-transform duration-200">
      <div className="flex flex-col">
        <div className="bg-[#D9D9D9] h-[200px] rounded-bl-lg rounded-br-lg">
          <img src="" alt="article.jpg" />
        </div>
        <div>
          <h1>{props.title} Article Title</h1>
        </div>
        <div>
          <h5>{props.byPerson}By This Person</h5>
        </div>
        <div>
          <p>{props.articleDescription}
            Sed ut perspiciatis unde omnis iste natus error sit voluptatem
            accusantium doloremque laudantium, totam rem aperiam, omnis iste
            natus error sit voluptatem accusantium omnis iste....
          </p>
        </div>
