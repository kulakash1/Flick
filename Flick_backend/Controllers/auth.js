...
const { mailTransport, generateEmailTemplate } = require("../Utils/emailTemplate.js");
...
exports.verifyEmail = async (req, res) => {
    ...
    if(!id || !otp.trim()) return sendError(res,"Invalid parameters!",400);
    ...
    if(user.verified) return sendError(res,"This user is already verified!",400);
